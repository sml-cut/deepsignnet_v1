...
def add_arguments(parser):
    ...
    # network
    parser.add_argument("--num_units",                  type=int,       default=1000,     help="Network size.")
    parser.add_argument("--num_layers",                 type=int,       default=4,      help="Network depth.")
    ...
    parser.add_argument("--residual",                   type="bool",    default=True,  nargs="?", const=True,  help="Whether to add residual connections.")
    ...
    parser.add_argument("--attention",              type=str,       default="luong",         help="""\luong | scaled_luong | bahdanau | normed_bahdanau or set to "" for no attention\ """)
    ...
    parser.add_argument("--tgt",            type=str,   default="de",   help="Target suffix, e.g., de.")
    ...
    parser.add_argument("--out_dir",        type=str,   default="model",   help="Store log/model files.")

    # Vocab
    parser.add_argument("--vocab_prefix",   type=str,       default="/usr/src/slt/slt/model/phoenix2014T.vocab",       help="""\ Vocab prefix, expect files with src/tgt suffixes.If None, extract from train files.\ """)
    ...
    parser.add_argument("--unit_type",          type=str,       default="gru", help="lstm | gru | layer_norm_lstm")
    ...
    # Inference
    parser.add_argument("--ckpt",                   type=str,   default="/usr/src/slt/slt/model/translate.ckpt-102000",     help="Checkpoint file to load a model for inference.")
    parser.add_argument("--inference_input_file",   type=str,   default="/usr/src/slt/slt/video/video_location.sign",   help="Set to the text to decode.")
    ...
    parser.add_argument("--inference_output_file",  type=str,   default="/usr/src/slt/slt/video/predictions.de",   help="Output file to store decoding results.")
